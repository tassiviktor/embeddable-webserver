...
public interface HttpStatusCodes {
    ...
    public static final int HTTP_PERMANENT_REDIRECT = 308;  // RFC7238
    ...
    public static final int HTTP_IM_A_TEAPOT = 418;           // RFC2324
    ...
    public static final int HTTP_VARIANT_ALSO_NEGOTIATES = 506;                                     // RFC2295
